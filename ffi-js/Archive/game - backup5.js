...
class Enemy extends Pawn {
    ...
    chooseTarget(target) {
        this.target = target;
        if (game.enemyTurn == enemies.length-1) {
...
class Imp extends Enemy {
    constructor(name, hp=10, strength, agility, intelligence, stamina, luck, attack, accuracy, defense, evasion, magicalDefense, command, target, alive) {
        super(name, hp, strength, agility, intelligence, stamina, luck, attack, accuracy, defense, evasion, magicalDefense, command, target, alive);
        this.name = "Imp";
    }
}
