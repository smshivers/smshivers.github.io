...
var game = {
    ...
    executePlayerCommand : function(i) {
        var heroCommand = heroes[i].command;

        switch (heroCommand) {
            case "fight" :
                gameUi.notification("pawn", heroes[i].name, 2000);
                gameUi.notification("target", heroes[i].target.name, 2000);
